...
with app.app_context():
    ...
    # added myself as a student user
    users = [
        ...
        {'username': 'tli12', 'email': 'tli12@terpmail.umd.edu', 'first_name':'Tina', 'last_name':'Li',
            'password': generate_password_hash('tli12', method='pbkdf2:sha256'), 'role':'STUDENT'}
    ]
