...
with app.app_context():
    ...
    # added email field as well with dummy data
    students = [
        {'student_id': '1', 'first_name': 'Robert', 'last_name':'Smith', 'major_id':3,
            'birth_date': dt.datetime(2007, 6, 1), 'is_honors':1, 'email': 'email1'},
        {'student_id': '2', 'first_name': 'Leo', 'last_name': 'Van Munching', 'major_id':6,
         'birth_date': dt.datetime(2008, 3, 24), 'is_honors': 0, 'email': 'email2'},
    ]
    # additionally prints out email along with all of the other fields in database
